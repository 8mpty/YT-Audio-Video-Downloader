...
from config import AUDIO_FORMAT, PREFERRED_AUDIO_CODEC, PREFERRED_AUDIO_QUALITY, WRITE_THUMBNAIL, VERBOSE_MODE, QUIET_MODE, DEFAULT_OUTTEMPLATE, TEMPFOLDER, KEEP_THUMBNAIL, delete_thumbnails
